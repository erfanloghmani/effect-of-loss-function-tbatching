...
# LOAD THE NETWORK
def load_network(args, time_scaling=True, n_history=10):
    '''
    ...
    for cnt, user in enumerate(user_sequence):
        ...
        user_latest_itemids[user][:-1] = user_latest_itemids[user][1:]
        user_latest_itemids[user][-1] = item2id[item_sequence[cnt]]
