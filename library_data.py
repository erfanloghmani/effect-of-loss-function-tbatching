...
def load_network(args, time_scaling=True):
    ...
    previous_item_previous_interaction = []
    for cnt, user in enumerate(user_sequence):
        ...
        previous_item_previous_interaction.append(item_latest_interaction[user_latest_itemid[user]])
    ...
    return [user2id, user_sequence_id, user_timedifference_sequence, user_previous_itemid_sequence, \
        ...
        timestamp_sequence, \
        feature_sequence, \
        y_true_labels, item_previous_interaction, previous_item_previous_interaction]
