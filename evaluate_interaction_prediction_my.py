...
user_interaction_list = defaultdict(list)
for i in range(test_end_idx):
    user_interaction_list[user_sequence_id[i]].append(i)
...
for user_id, interaction_list in tqdm(user_interaction_list.items()):
    item_embeddings = item_embeddings_dystat[:, :args.embedding_dim]
    item_embeddings = item_embeddings.clone()
