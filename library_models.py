...
class JODIE(nn.Module):
    def __init__(self, args, num_features, num_users, num_items, item_static_emb_size=None):
        ...
        if item_static_emb_size is None:
            self.item_static_embedding_size = num_items
        else:
            self.item_static_embedding_size = item_static_emb_size
        ...
        self.prediction_layer = nn.Linear(self.item_static_embedding_size + self.embedding_dim * 2, self.item_static_embedding_size + self.embedding_dim)
