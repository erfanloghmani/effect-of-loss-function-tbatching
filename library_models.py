...
class JODIE(nn.Module):
    def __init__(self, args, num_features, num_users, num_items, num_item_features):
        ...
        self.prediction_layer = nn.Linear(self.user_static_embedding_size + self.item_static_embedding_size + self. + self.embedding_dim + self.embedding_dim * 2, self.item_static_embedding_size + self.num_item_features + self.embedding_dim + 2)
